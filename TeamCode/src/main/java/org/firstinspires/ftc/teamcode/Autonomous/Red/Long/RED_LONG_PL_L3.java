...
@Autonomous
public class RED_LONG_PL_L3 extends OpMode {
    ...
    private final Pose shootPoseLong = new Pose((141.5 - 55.5),15, Math.toRadians(90-(112-90)));
    private final Pose LoadingZoneUpPose = new Pose((141.5 - 16),16,Math.toRadians(90-(270-90)));
    ...
    private final Pose LoadingZoneSideCurve = new Pose((141.5 - 52), 7.5);
        ...
        switch(pathState) {
            ...
            case SHOOT_PRELOAD_LONG:
                if (!follower.isBusy() ) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 5) {
                        setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_TAKE_LINE_3_LONG);
                        intake.setPower(0);
            ...
            case DRIVE_TAKE_LINE_3_LONG:
                if (!follower.isBusy() ) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_LINE_3_END_SHOOT_LONG_POS);
                }
                break;
            case DRIVE_LINE_3_END_SHOOT_LONG_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2.5)|| pathTimer.getElapsedTimeSeconds() > 3) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.SHOOT_LINE_3_LONG);
                }
                break;
