...
@Autonomous
public class RED_LONG_PL_LZ_L3_LZ extends OpMode {
    ...
    private  int OPEN_SHOOTER_SERVO_LONG = 1500;
    private int CLOSE_SHOOTER_SERVO_LONG = 1450;
    private static final double SHOOTER_POWER_LONG = 1690;
    ...
    public enum PathStateLong {
        // START POSITION_END POSITION
        // DRIVE > MOVEMENT
        // SHOOT
        // INTAKE
        DRIVE_START_LONG_POS_SHOOT_LONG_POS,
        SHOOT_PRELOAD_LONG,
        DRIVE_ROTATE_LINE_1,
        DRIVE_TAKE_LINE_3_LONG,
        DRIVE_LINE_3_END_SHOOT_LONG_POS,
        SHOOT_LINE_3_LONG,
        DRIVE_SHOOT_POS_LOAD_ZONE_POS,
        DRIVE_LOAD_ZONE_POS_SHOOT_POS,
        SHOOT_LZ_1,
        DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS,
        DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS,
        SHOOT_LZ_2,
        DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS_2,
        DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS_2,
        SHOOT_LZ_3,
        DRIVE_START_LINE_2_LONG_END_LINE_2,
        DRIVE_END_LINE_2_SHOOT_LONG_POS,
        SHOOT_LINE_2_LONG,
        DRIVE_START_LINE_1_LONG_END_LINE_1,
        DRIVE_END_LINE_1_SHOOT_LONG_POS,
        SHOOT_LINE_1_LONG,
        MOVE_OFF_LONG_LINE
    }

    PathStateLong pathState;
        ...
        switch(pathState) {
            ...
            case DRIVE_LOAD_ZONE_POS_SHOOT_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2.5) || pathTimer.getElapsedTimeSeconds() > 3) {
                    ...
                    setPathState(PathStateLong.SHOOT_LZ_1);
                }
                break;
            case SHOOT_LZ_1:
                if (!follower.isBusy() ) {
            ...
            case DRIVE_LINE_3_END_SHOOT_LONG_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2.2) || pathTimer.getElapsedTimeSeconds() > 3) {
            ...
            case DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2) || pathTimer.getElapsedTimeSeconds() > 2.5) {
                    ...
                    setPathState(PathStateLong.SHOOT_LZ_2);
                }
                break;
    ...
    public void setPathState(PathStateLong newState) {
        pathState = newState;
    ...
    public void init() {
        ...
        pathState = PathStateLong.DRIVE_START_LONG_POS_SHOOT_LONG_POS;
        pathTimer = new Timer();
