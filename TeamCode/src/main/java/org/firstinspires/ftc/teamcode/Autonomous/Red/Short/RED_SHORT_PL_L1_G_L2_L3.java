...
@Autonomous
public class RED_SHORT_PL_L1_G_L2_L3 extends OpMode{
    ...
    private final Pose line2End = new Pose((141.5 - 8.5),62, Math.toRadians(90-(180-90)));
    ...
    private final Pose line3End = new Pose((141.5 - 11), 39, Math.toRadians((90-(180-90))));
        ...
        switch(pathState) {
            ...
            case DRIVE_TAKE_LINE_1:
                if (!follower.isBusy() ) {
                    ...
                    setPathState(RED_SHORT_PL_L1.PathState.DRIVE_LINE_1_END_SHOOT_POS);
                }
                break;


            case DRIVE_LINE_1_END_SHOOT_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2) || pathTimer.getElapsedTimeSeconds() > 2) {
            ...
            case DRIVE_START_LINE_2_END_LINE_2:
                if (!follower.isBusy()) {
                    ...
                    setPathState(RED_SHORT_PL_L1.PathState.DRIVE_END_LINE_2_GATE_POS);
                }
                break;
