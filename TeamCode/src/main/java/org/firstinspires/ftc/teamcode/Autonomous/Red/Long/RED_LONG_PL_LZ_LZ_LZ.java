package org.firstinspires.ftc.teamcode.Autonomous.Red.Long;
...
@Autonomous
public class RED_LONG_PL_LZ_LZ_LZ extends OpMode {
    ...
    RED_LONG_PL_LZ_L3_LZ.PathStateLong pathState;

    private final Pose startPoseLong = new Pose((141.5 - 55.5),8, Math.toRadians(90-(90-90)));
    private final Pose shootPoseLong = new Pose((141.5 - 55.5),15, Math.toRadians(68));
    private final Pose LoadingZoneUpPose = new Pose((141.5 - 16),16, Math.toRadians(-90));
    private final Pose LoadingZoneUpCurve = new Pose((141.5 - 13),33);
    private final Pose LoadingZoneSidePose = new Pose((141.5 - 16),16, Math.toRadians(90-(180-90)));
    private final Pose LoadingZoneSideCurve = new Pose((141.5 - 52), 16);
    private final Pose line3LongStart = new Pose((141.5 - 55.5),15, Math.toRadians(90-(115-90)));
    private final Pose line3LongCurve = new Pose((141.5 - 60), 36);
    private final Pose line3LongEnd = new Pose((141.5 - 16), 41, Math.toRadians(90-(180-90)));
    private final Pose offPoseLong = new Pose((141.5 - 59),36, Math.toRadians(90-(90-90)));
    ...
    public void buildPaths() {
        ...
        driveShootLongPosLoadPosUpCurve = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(0), LoadingZoneUpPose.getHeading())
                .build();
        ...
        driveShootLongPosLoadPosSideCurve = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(0), LoadingZoneSidePose.getHeading())
                .build();
    ...
    public void statePathUpdate() {
        switch(pathState) {
            case DRIVE_START_LONG_POS_SHOOT_LONG_POS:
                ...
                setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.SHOOT_PRELOAD_LONG);
            ...
            case SHOOT_PRELOAD_LONG:
                if (!follower.isBusy() ) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 5.5) {
                        setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_SHOOT_POS_LOAD_ZONE_POS);
                        intake.setPower(0);
            ...
            case DRIVE_SHOOT_POS_LOAD_ZONE_POS:
                if (!follower.isBusy()) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_LOAD_ZONE_POS_SHOOT_POS);
                }
                break;
            case DRIVE_LOAD_ZONE_POS_SHOOT_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2.5) || pathTimer.getElapsedTimeSeconds() > 3) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.SHOOT_LZ_1);
                }
                break;
            case SHOOT_LZ_1:
                if (!follower.isBusy() ) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 5) {
                        setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS);
                        intake.setPower(0);
                        helper_motor.setPower(0);
                        flywheelR.setVelocity(ShooterVel());
                        flywheelL.setVelocity(ShooterVel());
            ...
            case DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS:
                if (!follower.isBusy()) {
                    ...
                    helper_motor.setPower(-0.8);
                    follower.followPath(driveShootLongPosLoadPosUpCurve);
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS);
                }
                break;
            ...
            case DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2) || pathTimer.getElapsedTimeSeconds() > 3) {
                    ...
                    helper_motor.setPower(0);
                    follower.followPath(driveLoadPosUpShootLongPos);
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.SHOOT_LZ_2);
                }
                break;
            ...
            case SHOOT_LZ_2:
                if (!follower.isBusy() ) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 5) {
                        ...
                        setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS_2);
                        intake.setPower(0);
                        helper_motor.setPower(0);
                        flywheelR.setVelocity(ShooterVel());
                        flywheelL.setVelocity(ShooterVel());
            ...
            case DRIVE_SHOOT_POS_LOAD_ZONE_SIDE_POS_2:
                if (!follower.isBusy()) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS_2);
                }
                break;
            ...
            case DRIVE_LOAD_ZONE_SIDE_POS_SHOOT_POS_2:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 2) || pathTimer.getElapsedTimeSeconds() > 2.5) {
                    ...
                    setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.SHOOT_LZ_3);
                }
                break;
            ...
            case SHOOT_LZ_3:
                if (!follower.isBusy() ) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 5) {
                        ...
                        setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong.MOVE_OFF_LONG_LINE);
                        intake.setPower(0);
                        helper_motor.setPower(0);
    ...
    public void setPathState(RED_LONG_PL_LZ_L3_LZ.PathStateLong newState) {
        pathState = newState;
    ...
    public void init() {
        ...
        pathState = RED_LONG_PL_LZ_L3_LZ.PathStateLong.DRIVE_START_LONG_POS_SHOOT_LONG_POS;
        pathTimer = new Timer();
