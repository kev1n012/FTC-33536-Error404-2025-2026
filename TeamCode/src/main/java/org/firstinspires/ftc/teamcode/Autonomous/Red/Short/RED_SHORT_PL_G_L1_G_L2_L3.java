...
@Autonomous
public class RED_SHORT_PL_G_L1_G_L2_L3 extends OpMode{
    ...
    private final Pose offPose = new Pose((141.5 - 26),90, Math.toRadians(90-(180-90)));
    ...
    public void statePathUpdate() {
        switch(pathState) {
            ...
            case DRIVE_END_LINE_1_GATE_POS:
                if ((!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1)|| pathTimer.getElapsedTimeSeconds() > 1){
            ...
            case DRIVE_END_LINE_2_GATE_POS:
                if ((!follower.isBusy())|| pathTimer.getElapsedTimeSeconds() > 3) {
                    ...
                    setPathState(RED_SHORT_PL_L1.PathState.DRIVE_GATE_POS_SHOOT_POS_2);
